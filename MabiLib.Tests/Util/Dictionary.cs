...
namespace MabiLib.Tests.Util
{
	public class MabiDictionaryTests
	{
		...
		{
			var dict = new Dictionary("boolTest:b:1;byteTest:1:1;shortTest:2:2;intTest:4:4;floatTest:f:4;longTest:8:8;stringTest:s:1234%S%C5678;");
